...
def trackObject(drone, info, turbines, starting_location, flag_rotate=0, flag_shift=0, flag_shift_direction = "none"):
    ...
    if info[0][0] == 0 and flag_rotate != 0:
        ...
        trackObject(drone, info, turbines, starting_location, flag_rotate)
    # if we did not find the center after finding it previously and our last command was a shift left. Move right the same distance.
        ...
        trackObject(drone, info, turbines, starting_location, flag_shift)
    ...
    if(x != 0):
        ...
        if(0 < x <= 340):
            ...
            trackObject(drone, info, turbines, starting_location, flag_rotate,  flag_shift, flag_shift_direction)
            img_pass = 1
