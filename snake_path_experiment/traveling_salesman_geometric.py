...
# xpos = np.array([0, lab_fans_x_coordinates[0], lab_fans_x_coordinates[1], lab_fans_x_coordinates[2]])
# xpos = np.append(xpos, xpos[0])
# ypos = np.array([0, lab_fans_y_coordinates[0], lab_fans_y_coordinates[1], lab_fans_y_coordinates[2]])
# ypos = np.append(ypos, ypos[0])
# data = np.array([xpos, ypos], np.int32)
        ...
        for location in range(int(coordinates.size/2)):
            ...
            if coordinates[0][location] == 0 or coordinates[0][location] == 1000: # second number to be changed to whatever the boundary size is
                ...
                if found == False: # We should end up here when we detected the incorrect QR code
                    ...
                    # Move the drone towards the target fan, stop short on x-axis by 300 cm and face forward to avoid detecting other fans
                    if target_turbine == "WindTurbine_1":  
                        drone.go_to(fans_x_coordinates[0] - 300, fans_y_coordinates[0], 0)
                    elif target_turbine == "WindTurbine_2":  
                        drone.go_to(fans_x_coordinates[1] - 300, fans_y_coordinates[1], 0)
                    elif target_turbine == "WindTurbine_3":  
                        drone.go_to(fans_x_coordinates[2] - 300, fans_y_coordinates[2], 0)
                    elif target_turbine == "WindTurbine_4":  
                        drone.go_to(fans_x_coordinates[3] - 300, fans_y_coordinates[3], 0)
                    elif target_turbine == "WindTurbine_5":  
                        drone.go_to(fans_x_coordinates[4] - 300, fans_y_coordinates[4], 0)
                    elif target_turbine == "WindTurbine_6":  
                        drone.go_to(fans_x_coordinates[5] - 300, fans_y_coordinates[5], 0)
                    elif target_turbine == "WindTurbine_7":  
                        drone.go_to(fans_x_coordinates[6] - 300, fans_y_coordinates[6], 0)
                    else:
